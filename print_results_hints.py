...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (results_dic[key][3] == 0 and results_dic[key][4] == 1) or (results_dic[key][3] == 0 and results_dic[key][4] == 0):
                tag = {0: 'NOT-a-Dog', 1: 'a-Dog'}
                print("Pet Image Label is {} - Classified as {}".format(tag[results_dic[key][3]], tag[results_dic[key][4]]))
